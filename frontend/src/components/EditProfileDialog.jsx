...
const EditProfileDialog = ({ open, setOpen }) => {
    ...
    const submitHandler = async (e) => {
        ...
        formData.append("intro", input.intro);
    ...
    return (
        <div>
            <Dialog open={open}>
                ...
                <DialogContent showCloseButton={false} className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className='grid gap-4 py-4'>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                <Label htmlFor="intro" className="text-right">Intro</Label>
                                <Input
                                    id="intro"
                                    name="intro"
                                    value={input.intro}
